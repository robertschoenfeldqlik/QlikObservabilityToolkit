...
export TMC_OTLP_ENDPOINT=http://localhost:4318</pre>
    ...
    <div class="panel">
      ...
      <ul style="margin:6px 0 0;padding-left:18px;line-height:1.9;">
        ...
        <li><a href="https://github.com/robertschoenfeldqlik/QlikObservabilityToolkit/blob/main/docs/otel-export.md" target="_blank" rel="noopener" style="color:var(--accent);font-weight:600;text-decoration:none;">Export to Datadog &amp; Splunk via OpenTelemetry</a> (collector config + setup)</li>
